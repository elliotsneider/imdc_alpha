  ...
  useEffect(() => {
    async function buildPrompt() {
      ...
      const parsed = links.map((link: any) => ({
        ...
        // Step 1: Build interest descriptions
        ...
        Use the following photograph to be the base of the image: "${profile.photo_url}"
        `
    ...
    const handleGenerate = async () => {
      ...
      // ⬇️ Upload image to Supabase via server-side API
